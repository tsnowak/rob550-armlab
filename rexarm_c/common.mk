...
ROOT_PATH    := $(subst /rexarm_c/common.mk,,$(realpath $(lastword $(MAKEFILE_LIST))))
SRC_PATH     := $(ROOT_PATH)/rexarm_c
...
LDFLAGS_MATH := -L$(LIB_PATH) -lmath $(LDFLAGS_COMMON) $(LDFLAGS_GSL)

# lcmtypes
CFLAGS_LCMTYPES  := -I$(SRC_PATH) -I$(SOLNS_PATH)/rexarm_c $(CFLAGS_LCM)
